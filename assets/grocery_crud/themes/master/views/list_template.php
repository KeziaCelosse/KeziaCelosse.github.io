 		...
 		<div class="row" style="margin-top: 10px">
        	<div class="table-section col-12"> 
				<div class="btn-primary" style="padding: 5px 5px">
                    <div class="" style="text-align: left; font-weight: bold; font-size: 18px">
                        <i class="fa fa-gear floatL t3"></i>&nbsp;<?php echo strtoupper($subject_plural); ?>
					</div>
                    <div class="clear"></div>
                </div>
                <div class="table-container">
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                        <div class="header-tools">
                            <?php if(!$unset_add){?>
                                <div class="floatL t5">
                                    <a class="btn bg-gradient-success" href="<?php echo $add_url?>"><i class="fa fa-plus"></i> &nbsp; <?php echo $this->l('list_add'); ?> <?php echo $subject?></a>
                                </div>
                            <?php } ?>
                            <div class="floatR">
                                <?php if(!$unset_export) { ?>
                                ...
                                <a class="btn btn-default search-button t5">
                        ...
                        <div class="scroll-if-required" style="height: 600px">
        							...
        							<td class="no-border-left <?php if ($buttons_counter === 0) {?>hidden<?php }?>">
                                        <div class="floatL">
                                            <a href="javascript:void(0);" title="<?php echo $this->l('list_delete')?>"
                                               class="hidden btn btn-danger delete-selected-button">
                                                <span class="">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 style="align: left" class="modal-title"><?php echo $this->l('list_delete'); ?></h4>
