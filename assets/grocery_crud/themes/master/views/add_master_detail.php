...
<form action="<?php echo base_url("master_transaksi/master_detail_save"); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" accept-charset="utf-8">
...
<!-- Start of GROCERY CRUD DATABASE INPUT -->
				...
				<div class="col-md-6">
                                <div class="form-group JobNo_form_group">
                                    <label class="col-sm-4 control-label">
                                        JobNo                                    </label>
                                    <div class="col-sm-7">
                                        <input id='field-JobNo' name='JobNo' type='text' value='' class='numeric form-control' maxlength='200' />                                    </div>
									</div>
                                <div class="form-group NamaCustomer_form_group">
                                    <label class="col-sm-4 control-label">
                                        Nama Customer                                    </label>
                                    <div class="col-sm-7">
                                        <input id='field-NamaCustomer' class='form-control' name='NamaCustomer' type='text' value="" maxlength='200' />                                    </div>
                                </div>
                                <div class="form-group AlamatCustomer_form_group">
                                    <label class="col-sm-4 control-label">
                                        AlamatCustomer                                    </label>
                                    <div class="col-sm-7">
                                        <input id='field-AlamatCustomer' class='form-control' name='AlamatCustomer' type='text' value="" maxlength='200' />                                    </div>
                                </div>
                                <div class="form-group NomorKontak_form_group">
                                    <label class="col-sm-4 control-label">
                                        NomorKontak                                    </label>
                                    <div class="col-sm-7">
                                        <input id='field-NomorKontak' class='form-control' name='NomorKontak' type='text' value="" maxlength='200' />                                    </div>
                                </div>
                                <div class="form-group Email_form_group">
                                    <label class="col-sm-4 control-label">
                                        Email                                    </label>
                                    <div class="col-sm-7">
                                        <input id='field-Email' class='form-control' name='Email' type='text' value="" maxlength='200' />                                    </div>
                                </div>
				</div>				
				<div class="col-md-6">
                                <div class="form-group TglDiterima_form_group" style="margin-bottom: -20px">
                                    <label class="col-sm-4 control-label">
                                        Tgl Diterima                                    </label>
                                    <div class="col-sm-7">
                                        <input id='field-TglDiterima' name='TglDiterima' type='text' value='' maxlength='19' class='datetime-input form-control' />
		...
		(dd/mm/yyyy) hh:mm:ss</span>                                    </div>
                                ...
                                <div class="form-group TglPembayaran_form_group" style="margin-bottom: -20px">
                                    ...
                                    <div class="col-sm-7">
                                        <input id='field-TglPembayaran' name='TglPembayaran' type='text' value='' maxlength='19' class='datetime-input form-control' />
		<span style="font-size: 12px;"><a class='datetime-input-clear' tabindex='-1'>Bersihkan</a>
		(dd/mm/yyyy) hh:mm:ss    </span>                                </div>
                                </div>
                                <div class="form-group TglPengiriman_form_group" style="margin-bottom: -20px">
                                    ...
                                    <div class="col-sm-7">
                                        <input id='field-TglPengiriman' name='TglPengiriman' type='text' value='' maxlength='19' class='datetime-input form-control' />
		<span style="font-size: 12px;"><a class='datetime-input-clear' tabindex='-1'>Bersihkan</a>
		(dd/mm/yyyy) hh:mm:ss  </span>                                  </div>
                                </div>
                                <div class="form-group KurirResi_form_group">
                                    <label class="col-sm-4 control-label">
                                        KurirResi                                    </label>
                                    <div class="col-sm-7">
                                        <input id='field-KurirResi' class='form-control' name='KurirResi' type='text' value="" maxlength='200' />                                    </div>
                                </div>
                                <div class="form-group TempatCasing_form_group">
                                    <label class="col-sm-4 control-label">
                                        TempatCasing                                    </label>
                                    <div class="col-sm-7">
                                        <input id='field-TempatCasing' class='form-control' name='TempatCasing' type='text' value="" maxlength='200' />                                    </div>
                                </div>
				</div>				
				</div>				
...
<div class="row">
<div class="col-md-12">
		<table id="table_detail" border="0" width="100%" style="font-size: 12px">
			<thead>
		...
		<button class="btn btn-primary" type="button" onclick="table_detail_add()">Tambah Baris</button>
</div>
</div>
...
<script type="text/javascript">
	...
	function table_detail_add() {
		...
		cell1.innerHTML = "<div style='padding: 2px 2px'><input class='form-control' type='text' name='name_"+num.toString()+"_"+row1+"' /></div>";
		...
		cell6.innerHTML = "<div style='padding: 2px 2px'><input class='form-control'type='text' name='name_"+num.toString()+"_"+row6+"' /></div>";

		var row7 = 7;
		var cell7 = row.insertCell(row7-1);
		cell7.innerHTML = "<div style='padding: 2px 2px'><input class='form-control'type='text' name='name_"+num.toString()+"_"+row7+"' /></div>";
		...
		cell9.innerHTML = "<div style='padding: 2px 2px'><input class='form-control'type='text' name='name_"+num.toString()+"_"+row9+"' /></div>";

		var row10 = 10;
		var cell10 = row.insertCell(row10-1);
		cell10.innerHTML = "<input class='btn btn-danger' type='button' onclick='table_detail_delete(this)' value='X' >";
