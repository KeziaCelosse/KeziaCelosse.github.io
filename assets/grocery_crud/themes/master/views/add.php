...
include(__DIR__ . '/database_native.php');
  ...
  function GetLastID($host, $user, $pass, $db){
	$connection = mysqli_connect($host,$user,$pass,$db);  
	$result = mysqli_query($connection, "SELECT MAX(JobNo) FROM crud_job_master");	  
...
<form action="<?php echo base_url("MasterTransaksi/master_detail_save"); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" accept-charset="utf-8">
				...
				<div class="col-md-6">
                                <div class="form-group JobNo_form_group">
                                    <label class="col-sm-4 control-label">
                                        JobNo                                    </label>
                                    <div class="col-sm-7">
                                        <input id='field-JobNo' name='JobNo' type='text' value='<?php GetLastID($host, $user, $pass, $db); ?>' class='numeric form-control' maxlength='200' />                                    </div>
									</div>
...
<div class="row">
	<div class="col-md-12">
		...
		<input type="hidden" id="table_detail_length" name="table_detail_length" value="0" />
							...
							<footer class="main-footer" style="height: 10px; z-index: 1000">
