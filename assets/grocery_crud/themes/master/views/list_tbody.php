                ...
                <div class="only-desktops"  style="white-space: nowrap">
                    <?php if (!empty($row->action_urls) || !$unset_read || !$unset_delete || !$unset_clone) { ?>
                        ...
                        <?php if ($show_more_button) { ?>
                            <div class="btn-group">
                                <button type="button" class="btn bg-gradient-primary dropdown-toggle gc-bootstrap-dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <?php if (!$unset_read) { ?>
                                        <li>
                                            <a href="<?php echo $row->read_url."/receive_order"?>">
                                                <i class="fa fa-edit"></i> Buat Receive Order
                                            </a>
                                        </li>
                                    <?php } ?>
                                    <?php if (!$unset_read) { ?>
                                        <li>
                                            <a href="<?php echo $row->edit_url?>">
                                                <i class="fa fa-database"></i> Ganti Data
                                            </a>
                                        </li>
                                    <?php } ?>
                                    <?php if (!$unset_read) { ?>
                                        <li>
                                            <a href="<?php echo $row->read_url."/invoice"?>">
                                                <i class="fa fa-money-bill"></i> Buat Invoice
                                            </a>
                                        </li>
                                    <?php } ?>
                                    <?php if (!$unset_read) { ?>
                            ...
                            <?php } else {
                                ...
                                if (!$unset_read) { ?>
                                    <a class="btn btn-default" href="<?php echo $row->read_url?>">
                                        <i class="fa fa-eye"></i> <?php echo $this->l('list_view')?>
                                    </a>
                                <?php }

                                if (!$unset_clone) { ?>
                                    <a class="btn btn-default" href="<?php echo $row->clone_url?>">
