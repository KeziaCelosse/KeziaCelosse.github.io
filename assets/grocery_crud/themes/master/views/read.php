...
include(__DIR__ . '/database_native.php');
  ...
  if (isset($uri_explode[4])){
	$pagetype = $uri_explode[4]; 
  } else {
	$pagetype = "read";  
  }
  ...
  $FORM_METHOD = "post";
  if ($pagetype == "read"){
	  $PAGE_TITLE = "Data Perbaikan";
	  $FORM_ACTION = base_url("#");
  }	  
  if ($pagetype == "receive_order"){
	  $PAGE_TITLE = "Receive Order";
	  $FORM_ACTION = base_url("print/print_receive_order.php?primary_key=$primary_key");
	  $FORM_TARGET = "_blank";
  }	  
  if ($pagetype == "invoice"){
	  $PAGE_TITLE = "Invoice";
	  $FORM_ACTION = base_url("print/print_invoice.php?primary_key=$primary_key");
	  $FORM_TARGET = "_blank";
	  $FORM_METHOD = "get";
  }	  
...
?>
<br/>
<div class="<?php echo $FORM_TARGET; ?>" data-unique-hash="<?php echo $unique_hash; ?>">
            <div class="col-md-12">
				<div class="btn-secondary" style="padding: 5px 5px">
...
<form target="_blank" action="<?php echo $FORM_ACTION ?>" method="<?php $FORM_METHOD; ?>" enctype="multipart/form-data" class="form-horizontal" accept-charset="utf-8">
...
<!-- Start of GROCERY CRUD DATABASE INPUT -->
				...
				<div class="col-md-6">
                                <div class="form-group JobNo_form_group">
                                    <label class="col-sm-4 control-label">
                                        JobNo                                    </label>
                                    <div class="col-sm-7">
                                        <input readonly style="background-color: #CCCCCC"value='<?php echo $row_data[0]; ?>' readonly id='field-JobNo' name='JobNo' type='text' class='numeric form-control' maxlength='200' />                                    </div>
									</div>
                                <div class="form-group NamaCustomer_form_group">
                                    <label class="col-sm-4 control-label">
                                        Nama Customer                                    </label>
                                    <div class="col-sm-7">
                                        <input readonly style="background-color: #CCCCCC"value='<?php echo $row_data[1]; ?>'id='field-NamaCustomer' class='form-control' name='NamaCustomer' type='text' value="" maxlength='200' />                                    </div>
                                </div>
                                <div class="form-group AlamatCustomer_form_group">
                                    <label class="col-sm-4 control-label">
                                        AlamatCustomer                                    </label>
                                    <div class="col-sm-7">
                                        <input readonly style="background-color: #CCCCCC"value='<?php echo $row_data[2]; ?>'id='field-AlamatCustomer' class='form-control' name='AlamatCustomer' type='text' value="" maxlength='200' />                                    </div>
                                </div>
                                <div class="form-group NomorKontak_form_group">
                                    <label class="col-sm-4 control-label">
                                        NomorKontak                                    </label>
                                    <div class="col-sm-7">
                                        <input readonly style="background-color: #CCCCCC"value='<?php echo $row_data[3]; ?>'id='field-NomorKontak' class='form-control' name='NomorKontak' type='text' value="" maxlength='200' />                                    </div>
                                </div>
                                <div class="form-group Email_form_group">
                                    <label class="col-sm-4 control-label">
                                        Email                                    </label>
                                    <div class="col-sm-7">
                                        <input readonly style="background-color: #CCCCCC"value='<?php echo $row_data[4]; ?>'id='field-Email' class='form-control' name='Email' type='text' value="" maxlength='200' />                                    </div>
                                </div>
				</div>				
				<div class="col-md-6">
                                <div class="form-group TglDiterima_form_group" style="margin-bottom: -20px">
                                    <label class="col-sm-4 control-label">
                                        Tgl Diterima                                    </label>
                                    <div class="col-sm-7">
                                        <input readonly style="background-color: #CCCCCC"value='<?php echo $row_data[5]; ?>'id='field-TglDiterima' name='TglDiterima' type='text' value='' maxlength='19' class='datetime-input form-control' />
		<span style="font-size: 12px;">(dd/mm/yyyy) hh:mm:ss</span>                                    </div>
                                </div>
                                <div class="form-group TglPembayaran_form_group" style="margin-bottom: -20px">
                                    <label class="col-sm-4 control-label">
                                        Tgl Pembayaran                                    </label>
                                    <div class="col-sm-7">
                                        <input readonly style="background-color: #CCCCCC"value='<?php echo $row_data[6]; ?>'id='field-TglPembayaran' name='TglPembayaran' type='text' value='' maxlength='19' class='datetime-input form-control' />
		...
		(dd/mm/yyyy) hh:mm:ss    </span>                                </div>
                                ...
                                <div class="form-group TglPengiriman_form_group" style="margin-bottom: -20px">
                                    ...
                                    <div class="col-sm-7">
                                        <input readonly style="background-color: #CCCCCC"value='<?php echo $row_data[7]; ?>'id='field-TglPengiriman' name='TglPengiriman' type='text' value='' maxlength='19' class='datetime-input form-control' />
		<span style="font-size: 12px;">
		(dd/mm/yyyy) hh:mm:ss  </span>                                  </div>
                                </div>
                                <div class="form-group KurirResi_form_group">
                                    <label class="col-sm-4 control-label">
                                        KurirResi                                    </label>
                                    <div class="col-sm-7">
                                        <input readonly style="background-color: #CCCCCC"value='<?php echo $row_data[8]; ?>'id='field-KurirResi' class='form-control' name='KurirResi' type='text' value="" maxlength='200' />                                    </div>
                                </div>
                                <div class="form-group TempatCasing_form_group">
                                    <label class="col-sm-4 control-label">
                                        TempatCasing                                    </label>
                                    <div class="col-sm-7">
                                        <input readonly style="background-color: #CCCCCC"value='<?php echo $row_data[9]; ?>'id='field-TempatCasing' class='form-control' name='TempatCasing' type='text' value="" maxlength='200' />                                    </div>
                                </div>
				</div>				
				</div>				
<!-- End of GROCERY CRUD DATABASE INPUT -->						
                            ...
                            <div class="form-group" style="margin-top:-10px;">
                                ...
                                <div class="col-sm-offset-0 col-sm-7">
									...
									<?php 	if ($pagetype == "receive_order"){ ?>
                                        <button class="btn bg-gradient-primary cancel-button b10" type="submit" >
                                            <i class="fa fa-print"></i>
                                            Cetak Receive Order
                                        </button>
									<?php } ?>
								
									<?php 	if ($pagetype == "invoice"){ ?>
                                        <button class="btn bg-gradient-success cancel-button b10" type="submit" >
...
<div class="row">
	<div class="col-md-12">
		...
		<table id="table_detail" border="0" style="width: 100%; font-size: 12px">
			<thead>
				<tr style="height: 30px" class="btn-secondary">
			...
			<tbody>
				...
				<tr style="height: 30px">
					<td><center><div style="width: 120px; padding: 2px 2px"><input readonly style="background-color: #CCCCCC" value="<?php echo $row_detail_data[2]; ?>" class="form-control" type="text" id="name_<?php echo $index; ?>_1" name="name_<?php echo $index; ?>_1" /></div></td>
					<td><center><div style="padding: 2px 2px"><input readonly style="background-color: #CCCCCC"value="<?php echo $row_detail_data[3]; ?>"class="form-control" type="text" id="name_<?php echo $index; ?>_2" name="name_<?php echo $index; ?>_2" /></div></td>
					<td><center><div style="padding: 2px 2px"><input readonly style="background-color: #CCCCCC"value="<?php echo $row_detail_data[4]; ?>"class="form-control" type="text" id="name_<?php echo $index; ?>_3" name="name_<?php echo $index; ?>_3" /></div></td>
					<td><center><div style="padding: 2px 2px"><input readonly style="background-color: #CCCCCC"value="<?php echo $row_detail_data[5]; ?>"class="form-control" type="text" id="name_<?php echo $index; ?>_4" name="name_<?php echo $index; ?>_4" /></div></td>
					<td><center><div style="padding: 2px 2px"><input readonly style="background-color: #CCCCCC"value="<?php echo $row_detail_data[6]; ?>"class="form-control" type="text" id="name_<?php echo $index; ?>_5" name="name_<?php echo $index; ?>_5" /></div></td>
					<td><center><div style="padding: 2px 2px"><select readonly style="background-color: #CCCCCC"id="name_<?php echo $index; ?>_6" name="name_<?php echo $index; ?>_6" class='form-control' ><?php GetComboBoxUpdate($host, $user, $pass, $db, "crud_status_resolusi", "$row_detail_data[7]"); ?></select></div></td>
					<td><center><div style="padding: 2px 2px"><select readonly style="background-color: #CCCCCC"id="name_<?php echo $index; ?>_7" name="name_<?php echo $index; ?>_7" class='form-control' ><?php GetComboBoxUpdate($host, $user, $pass, $db, "crud_status_perbaikan", "$row_detail_data[8]"); ?></select></div></td>
					<td><center><div style="padding: 2px 2px"><input readonly style="background-color: #CCCCCC" value="<?php echo $row_detail_data[9]; $subtotal = $subtotal + $row_detail_data[9]; ?>"class="form-control" type="text" id="name_<?php echo $index; ?>_8" name="name_<?php echo $index; ?>_8" /></div></td>
				</tr>
				<?php
					$index++;
					}
		...
		<?php if ($pagetype == "invoice"){ ?>
				<tr style="height: 30px">
					...
					<td><center></td>
					<td><center></td>
					<td><center><b style="font-size: 16px">SUBTOTAL</b></td>
					<td><center><div style="padding: 2px 2px"><input style="background-color: #FFFFFF" class="form-control" type="text" name="subtotal" value="<?php echo $subtotal; ?>" /></div></td>
				</tr>
				<tr style="height: 5px; background-color: #DDDDDD">
					<td><center></td>
					<td><center></td>
					<td><center></td>
					<td><center></td>
					<td><center></td>
					<td><center></td>
					<td><center><b style="font-size: 1px">&nbsp;</b></td>
					<td><center><div style="padding: 2px 2px"></div></td>
				</tr>				
				<tr style="height: 30px">
					<td><center></td>
					<td><center></td>
					...
					<td><center></td>
					<td><center></td>
					<td><center><b style="font-size: 16px">EKSPEDISI</b></td>
					<td><center><div style="padding: 2px 2px"><input style="background-color: #FFFFFF" class="form-control" type="text" name="ekspedisi" /></div></td>
				</tr>
				<tr style="height: 30px">
					<td><center></td>
					<td><center></td>
					...
					<td><center></td>
					<td><center></td>
					<td><center><b style="font-size: 16px">BERAT KG</b></td>
					<td><center><div style="padding: 2px 2px"><input style="background-color: #FFFFFF" class="form-control" type="text" name="beratkg" /></div></td>
				</tr>
				<tr style="height: 30px">
					<td><center></td>
					<td><center></td>
					...
					<td><center></td>
					<td><center></td>
					<td><center><b style="font-size: 16px">ONGKOS KIRIM</b></td>
					<td><center><div style="padding: 2px 2px"><input style="background-color: #FFFFFF" class="form-control" type="text" name="ongkoskirim" /></div></td>
				</tr>
				<tr style="height: 30px; background-color: #CCCCCC">
					...
					<td><center></td>
					<td><center></td>
					<td><center><b style="font-size: 16px">GRAND TOTAL</b></td>
					<td><center><div style="padding: 2px 2px"><input style="background-color: #FFFFFF" class="form-control" type="text" name="grandtotal" /></div></td>
				</tr>
		<?php } ?>
