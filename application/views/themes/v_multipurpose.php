...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,400i,700,700i%7CRajdhani:400,600,700"
        rel="stylesheet">
    <!-- Plugins Stylesheets -->
    <link rel="stylesheet" href="<?php echo base_url()."assets/multipurpose/"; ?>assets/css/loader/loaders.css">
    <link rel="stylesheet" href="<?php echo base_url()."assets/multipurpose/"; ?>assets/css/font-awesome/font-awesome.css">
    <link rel="stylesheet" href="<?php echo base_url()."assets/multipurpose/"; ?>assets/css/bootstrap.css">
    <link rel="stylesheet" href="<?php echo base_url()."assets/multipurpose/"; ?>assets/css/aos/aos.css">
    <link rel="stylesheet" href="<?php echo base_url()."assets/multipurpose/"; ?>assets/css/swiper/swiper.css">
    <link rel="stylesheet" href="<?php echo base_url()."assets/multipurpose/"; ?>assets/css/lightgallery.min.css">
    <!-- Template Stylesheet -->
    <link rel="stylesheet" href="<?php echo base_url()."assets/multipurpose/"; ?>assets/css/style.css">
    <!-- Responsive Stylesheet -->
    <link rel="stylesheet" href="<?php echo base_url()."assets/multipurpose/"; ?>assets/css/responsive.css">
</head>
...
<body>
    ...
    <header class="position-absolute w-100">
        <div class="container">
            ...
            <nav class="navbar navbar-expand-md navbar-light">
                <a class="navbar-brand" href="index.html"><img src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/logo.png" alt="Multipurpose"></a>
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-4">
                        <div class="media" data-aos="fade-up" data-aos-delay="200" data-aos-duration="400">
                            <img class="mr-4" src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/service1.png" alt="Web Development">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="media" data-aos="fade-up" data-aos-delay="400" data-aos-duration="600">
                            <img class="mr-4" src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/service2.png" alt="Web Development">
                            <div class="media-body">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="media" data-aos="fade-up" data-aos-delay="600" data-aos-duration="800">
                            <img class="mr-4" src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/service3.png" alt="Web Development">
                            <div class="media-body">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="media" data-aos="fade-up" data-aos-delay="200" data-aos-duration="400">
                            <img class="mr-4" src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/service4.png" alt="Web Development">
                            <div class="media-body">
                                <h5>Modern style</h5>
                                Donec volutpat tincidunt neque, vitae lobortis libero mattis sed tempus.
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="media" data-aos="fade-up" data-aos-delay="600" data-aos-duration="800">
                            <img class="mr-4" src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/service5.png" alt="Web Development">
                            <div class="media-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6" data-aos="fade-left" data-aos-delay="400" data-aos-duration="800">
                    <div class="featured-img">
                        <img class="featured-big" src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/featured-img1.jpg" alt="Featured 1">
                        <img class="featured-small" src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/featured-img2.jpg" alt="Featured 2">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-right"
                        ...
                        <div class="post-thumb">
                            <img class="img-fluid" src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/post1.jpg" alt="Post 1">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-left" data-aos-duration="800">
                        <div class="post-thumb">
                            <img class="img-fluid" src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/post2.jpg" alt="Post 1">
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-right" data-aos-delay="200"
                        ...
                        <div class="post-thumb">
                            <img class="img-fluid" src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/post3.jpg" alt="Post 1">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-left" data-aos-delay="200"
                        data-aos-duration="800">
                        <div class="post-thumb">
                            <img class="img-fluid" src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/post4.jpg" alt="Post 1">
                        </div>
                        <div class="post-content">
                            <time datetime="2019-04-06T13:53">15 Oct, 2019</time>
                ...
                <div class="col-xl-5 gallery">
                    <div class="row no-gutters h-100" id="lightgallery">
                        <a href="https://lorempixel.com/600/400/" class="w-50 h-100 gal-img" data-aos="fade-up"
                            ...
                            <img class="img-fluid" src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/gallery1.jpg" alt="Gallery Image">
                        ...
                        <a href="https://lorempixel.com/600/400/" class="w-50 h-50 gal-img" data-aos="fade-up"
                            ...
                            <img class="img-fluid" src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/gallery2.jpg" alt="Gallery Image">
                            <i class="fa fa-caret-right"></i>
                        </a>
                        <a href="https://lorempixel.com/600/400/" class="w-50 h-50 gal-img gal-img3" data-aos="fade-up"
                            ...
                            <img class="img-fluid" src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/gallery3.jpg" alt="Gallery Image">
                            <i class="fa fa-caret-right"></i>
                        </a>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="offset-lg-1 col-lg-10">
                                    <div class="test-img" data-aos="fade-up" data-aos-delay="0" data-aos-offset="0"><img
                                            src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/test1.png" alt="Testimonial 1"></div>
                ...
                <div class="swiper-container clients-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/client1.png" alt="Client 1">
                        </div>
                        <div class="swiper-slide">
                            <img src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/client2.png" alt="Client 2">
                        </div>
                        <div class="swiper-slide">
                            <img src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/client3.png" alt="Client 3">
                        </div>
                        <div class="swiper-slide">
                            <img src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/client4.png" alt="Client 4">
                        </div>
                        <div class="swiper-slide">
                            <img src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/client5.png" alt="Client 5">
                        </div>
                    </div>
                    <div class="test-pagination"></div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="single-widget recent-post-widget" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="media">
                                <a class="rcnt-img" href="#"><img src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/rcnt-post1.png"
                                        alt="Recent Post"></a>
                                <div class="media-body ml-3">
                            ...
                            <div class="media">
                                <a class="rcnt-img" href="#"><img src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/rcnt-post2.png"
                                        alt="Recent Post"></a>
                                <div class="media-body ml-3">
                            ...
                            <div class="media">
                                <a class="rcnt-img" href="#"><img src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/rcnt-post3.png"
                                        alt="Recent Post"></a>
                                <div class="media-body ml-3">
                            ...
                            <div class="media">
                                <a class="rcnt-img" href="#"><img src="<?php echo base_url()."assets/multipurpose/"; ?>assets/images/rcnt-post4.png"
                                        alt="Recent Post"></a>
                                <div class="media-body ml-3">
    ...
    <!-- Footer Endt -->
    <!--jQuery-->
    <script src="<?php echo base_url()."assets/multipurpose/"; ?>assets/js/jquery-3.3.1.js"></script>
    <!--Plugins-->
    <script src="<?php echo base_url()."assets/multipurpose/"; ?>assets/js/bootstrap.bundle.js"></script>
    <script src="<?php echo base_url()."assets/multipurpose/"; ?>assets/js/loaders.css.js"></script>
    <script src="<?php echo base_url()."assets/multipurpose/"; ?>assets/js/aos.js"></script>
    <script src="<?php echo base_url()."assets/multipurpose/"; ?>assets/js/swiper.min.js"></script>
    <script src="<?php echo base_url()."assets/multipurpose/"; ?>assets/js/lightgallery-all.min.js"></script>
    <!--Template Script-->
    <script src="<?php echo base_url()."assets/multipurpose/"; ?>assets/js/main.js"></script>
</body>
