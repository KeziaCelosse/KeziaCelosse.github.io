...
<head>
  ...
  <!-- PLUGINS CSS STYLE -->
  <link rel="stylesheet" href="<?php echo base_url()."assets/apps/"; ?>plugins/bootstrap/bootstrap.min.css">
  <link rel="stylesheet" href="<?php echo base_url()."assets/apps/"; ?>plugins/themify-icons/themify-icons.css">
  <link rel="stylesheet" href="<?php echo base_url()."assets/apps/"; ?>plugins/slick/slick.css">
  <link rel="stylesheet" href="<?php echo base_url()."assets/apps/"; ?>plugins/slick/slick-theme.css">
  <link rel="stylesheet" href="<?php echo base_url()."assets/apps/"; ?>plugins/fancybox/jquery.fancybox.min.css">
  <link rel="stylesheet" href="<?php echo base_url()."assets/apps/"; ?>plugins/aos/aos.css">
...
<nav class="navbar main-nav navbar-expand-lg px-2 px-sm-0 py-2 py-lg-0">
  <div class="container">
    <a class="navbar-brand" href="index.html"><img src="<?php echo base_url()."assets/apps/"; ?>images/logo.png" alt="logo"></a>
	...
	<div class="container">
		<div class="row align-items-center">
			...
			<div class="col-md-6 text-center order-1 order-md-2">
				<img class="img-fluid" src="<?php echo base_url()."assets/apps/"; ?>images/mobile.png" alt="screenshot">
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-lg-6 ml-auto justify-content-center">
				...
				<div class="image-content" data-aos="fade-right">
					<img class="img-fluid" src="<?php echo base_url()."assets/apps/"; ?>images/feature/feature-new-01.jpg" alt="iphone">
				</div>
			</div>
				...
				<div class="testimonial">
					...
					<ul class="list-inline meta">
						<li class="list-inline-item">
							<img src="<?php echo base_url()."assets/apps/"; ?>images/testimonial/feature-testimonial-thumb.jpg" alt="">
						</li>
		...
		<div class="row">
			...
			<div class="col-lg-6 mr-auto justify-content-center">
				...
				<div class="image-content" data-aos="fade-left">
					<img class="img-fluid" src="<?php echo base_url()."assets/apps/"; ?>images/feature/feature-new-02.jpg" alt="ipad">
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-6 align-self-center">
				...
				<div class="service-thumb left" data-aos="fade-right">
					<img class="img-fluid" src="<?php echo base_url()."assets/apps/"; ?>images/feature/iphone-ipad.jpg" alt="iphone-ipad">
				</div>
			</div>
				...
				<div class="testimonial-slider owl-carousel owl-theme">
					...
					<div class="item">
						<div class="block shadow">
							...
							<!-- Person Thumb -->
							<div class="image">
								<img src="<?php echo base_url()."assets/apps/"; ?>images/testimonial/feature-testimonial-thumb.jpg" alt="image">
							</div>
							<!-- Name and Company -->
...
<footer>
  ...
  <script src="<?php echo base_url()."assets/apps/"; ?>plugins/bootstrap/bootstrap.min.js"></script>
  <script src="<?php echo base_url()."assets/apps/"; ?>plugins/slick/slick.min.js"></script>
  <script src="<?php echo base_url()."assets/apps/"; ?>plugins/fancybox/jquery.fancybox.min.js"></script>
  <script src="<?php echo base_url()."assets/apps/"; ?>plugins/syotimer/jquery.syotimer.min.js"></script>
  <script src="<?php echo base_url()."assets/apps/"; ?>plugins/aos/aos.js"></script>
  <!-- google map -->
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAgeuuDfRlweIs7D6uo4wdIHVvJ0LonQ6g"></script>
  <script src="<?php echo base_url()."assets/apps/"; ?>plugins/google-map/gmap.js"></script>
